...
def process_station(s):
    ...
    # Skip testing for speed; handled by ingest.py
    status, codec = "untested", "unknown"
    print(f"{CYAN}[UNTESTED]{NC} {name}")
    ...
    return {
        ...
        "stream_url": stream,
        "website": "https://you.radio", # YouRadio is the brand/source for these stations
        "provider": "youradio",
        "country": "Global",
        "genres": tags,
        "languages": [], # Not provided by their API
        "description": s.get("seo_description", "") or "",
        "status": status,
        "codec": codec,
